...
def binary_search(fd, search_time_tuple, start_byte, end_byte, file_size):
    ...
    if found_time_tuple == search_time_tuple:
        ...
        binary_search(fd, search_time_tuple, last_found_byte + 1, end_byte, file_size)
    else:
        binary_search(fd, search_time_tuple, start_byte, center_byte - 1, file_size)
...
def main():
    ...
    search_time_tuple = time.strptime("01/Aug/1983:03:41:09", "%d/%b/%Y:%H:%M:%S")
